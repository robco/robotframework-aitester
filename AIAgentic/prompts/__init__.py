...
from .web_executor import WEB_EXECUTOR_SYSTEM_PROMPT
from .api_executor import API_EXECUTOR_SYSTEM_PROMPT
from .mobile_executor import MOBILE_EXECUTOR_SYSTEM_PROMPT
from .reporter import REPORTER_SYSTEM_PROMPT

SUPERVISOR_PROMPT = SUPERVISOR_SYSTEM_PROMPT
TEST_PLANNER_PROMPT = PLANNER_SYSTEM_PROMPT
WEB_EXECUTOR_PROMPT = WEB_EXECUTOR_SYSTEM_PROMPT
API_EXECUTOR_PROMPT = API_EXECUTOR_SYSTEM_PROMPT
MOBILE_EXECUTOR_PROMPT = MOBILE_EXECUTOR_SYSTEM_PROMPT
